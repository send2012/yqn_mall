<template>
	<md-field-group class="register_submit">
		<md-field v-model="code" icon="yqn_login_pwd" placeholder="请输入验证码">
		...
		<md-field v-model="password" icon="yqn_login_pwd" placeholder="请输入密码"/>
		<md-field v-model="repeatPassword" icon="yqn_login_pwd" placeholder="请再次确认密码"/>
