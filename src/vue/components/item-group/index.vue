<template>
	<div class="items_group" :style="'background: ' + background">
		<van-cell-group v-if="setting && !!setting.title" class="yqn_home_title">
			<van-cell>
				<home-title 
					:title="setting.title"
					:sub_title="setting.sub_title"
					:count_down="setting.count_down" 
					:more="setting.more" />
		...
		<div class="item_scroll_box" v-if="setting.style === 1">
			...
			<transition name="fade">
				<van-icon name="yqn_rightIcon" v-show="leftOver && isShowArrow" class="items_arrow right_arrow" />
			</transition>
			<transition name="fade">
				<van-icon name="yqn_leftIcon" v-show="rightOver && isShowArrow" class="items_arrow left_arrow" />
			</transition>
		</div>
		
		<div v-else :class="setting.style?'item_card_doub':'item_card_normal'">
			<slot></slot>
		</div>
